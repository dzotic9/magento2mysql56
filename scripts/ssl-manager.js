function SSLManager(config) {
    ...
    me.invoke = function (action) {
        ...
        java.lang.System.out.println("DEBUG LE - me.invoke - action -> " + action);
    ...
    me.autoUpdate = function () {
      ...
      java.lang.System.out.println("DEBUG LE - in me.autoUpdate -> ");
        ...
        if (!config.isTask) {
            ...
            java.lang.System.out.println("DEBUG LE - session -> " + session);
            if (!session && me.hasValidToken()) {
                java.lang.System.out.println("DEBUG LE - in !session && me.hasValidToken()) -> ");
                session = signature;
            }
