...
--
-- Хост: localhost
-- Время создания: Мар 23 2016 г., 07:21
...
--
-- Структура таблицы `admin_passwords`
--
...
--
-- Структура таблицы `admin_system_messages`
--
...
(1, 'admin', 'admin', 'alexey.lazarenko@hivext.net', 'admin', 'cbed9f33850380dc991a733f466fb475ab1c208d7211ecad280c7db51dfbf3e1:HUgRhJHphDdQXX6X6eLrQjQJsHO5vGx5:1', '2016-03-22 23:34:58', '2016-03-22 23:34:58', NULL, 0, 0, 1, 'N;', NULL, NULL, 'en_US', 0, NULL, NULL);
...
--
-- Структура таблицы `authorization_rule`
--
...
--
-- Дамп данных таблицы `authorization_rule`
--
...
--
-- Структура таблицы `catalogsearch_fulltext_scope1`
--
...
(1, 0, 0, '2016-03-22 23:34:52', '2016-03-22 23:34:53', '1', 0, 0, 1),
(2, 3, 1, '2016-03-22 23:34:53', '2016-03-22 23:34:53', '1/2', 1, 1, 0);
...
--
-- Структура таблицы `catalog_product_entity_media_gallery_value_to_entity`
--
...
--
-- Структура таблицы `catalog_product_entity_media_gallery_value_video`
--
...
--
-- Структура таблицы `catalog_url_rewrite_product_category`
--
...
--
-- Дамп данных таблицы `customer_eav_attribute_website`
--
...
--
-- Структура таблицы `customer_grid_flat`
--
...
--
-- Структура таблицы `customer_log`
--
...
--
-- Структура таблицы `customer_visitor`
--
...
--
-- Дамп данных таблицы `customer_visitor`
--

INSERT INTO `customer_visitor` (`visitor_id`, `customer_id`, `session_id`, `last_visit_at`) VALUES
(1, NULL, '8f9ob6cr30r6l41aivvn7n9hb5', '2016-03-22 23:35:59');
...
--
-- Структура таблицы `eav_attribute_option_swatch`
--
...
--
-- Структура таблицы `googleoptimizer_code`
--
...
--
-- Структура таблицы `import_history`
--
...
--
-- Структура таблицы `indexer_state`
--
...
--
-- Дамп данных таблицы `indexer_state`
--

INSERT INTO `indexer_state` (`state_id`, `indexer_id`, `status`, `updated`, `hash_config`) VALUES
(1, 'customer_grid', 'valid', '2016-03-22 23:34:50', '9b4506442a512a649dde7c6f25924134'),
(2, 'catalog_category_product', 'invalid', '2016-03-22 23:34:50', '86038392fe878acd22d5650a99b4f9b3'),
(3, 'catalog_product_category', 'invalid', '2016-03-22 23:34:50', '8fd6f9a1ec8741ce1c7984b549915e8e'),
(4, 'catalog_product_price', 'invalid', '2016-03-22 23:34:50', '0dce29088c0563479f66b2a70ebf152b'),
(5, 'catalog_product_attribute', 'invalid', '2016-03-22 23:34:50', '5ee6fe2540126b9b2c90c53fe25c4d9a'),
(6, 'cataloginventory_stock', 'invalid', '2016-03-22 23:34:50', '030021373629a9e2b3b8ffcc92be9483'),
(7, 'catalogrule_rule', 'invalid', '2016-03-22 23:34:50', '63676f01f658a0964f150347a6596a0a'),
(8, 'catalogrule_product', 'invalid', '2016-03-22 23:34:50', 'f9512548ab97beef43ea393d4a6dc545'),
(9, 'catalogsearch_fulltext', 'valid', '2016-03-22 23:34:56', 'a959fbd517e02dc6c79ef261cc983c97');
...
--
-- Структура таблицы `layout_update`
--
...
--
-- Структура таблицы `paypal_billing_agreement`
--
...
--
-- Структура таблицы `paypal_billing_agreement_order`
--
...
--
-- Структура таблицы `quote_address`
--
...
--
-- Структура таблицы `quote_address_item`
--
...
--
-- Структура таблицы `quote_id_mask`
--
...
--
-- Структура таблицы `quote_item_option`
--
...
--
-- Структура таблицы `quote_payment`
--
...
--
-- Структура таблицы `quote_shipping_rate`
--
...
--
-- Структура таблицы `reporting_counts`
--
...
--
-- Структура таблицы `reporting_module_status`
--
...
--
-- Структура таблицы `reporting_orders`
--
...
--
-- Структура таблицы `reporting_system_updates`
--
...
--
-- Структура таблицы `reporting_users`
--
...
--
-- Структура таблицы `salesrule_coupon_aggregated`
--
...
--
-- Структура таблицы `salesrule_coupon_aggregated_order`
--
...
--
-- Структура таблицы `salesrule_coupon_aggregated_updated`
--
...
--
-- Структура таблицы `sales_creditmemo`
--
...
--
-- Структура таблицы `sales_creditmemo_comment`
--
...
--
-- Структура таблицы `sales_creditmemo_grid`
--
...
--
-- Структура таблицы `sales_creditmemo_item`
--
...
--
-- Структура таблицы `sales_invoice_comment`
--
...
--
-- Структура таблицы `sales_invoice_grid`
--
...
--
-- Структура таблицы `sales_invoice_item`
--
...
--
-- Структура таблицы `sales_order_address`
--
...
--
-- Структура таблицы `sales_order_grid`
--
...
--
-- Структура таблицы `sales_order_item`
--
...
--
-- Структура таблицы `sales_order_payment`
--
...
--
-- Структура таблицы `sales_order_status_history`
--
...
--
-- Структура таблицы `sales_sequence_meta`
--
...
--
-- Дамп данных таблицы `sales_sequence_meta`
--
...
--
-- Структура таблицы `sales_sequence_profile`
--
...
--
-- Дамп данных таблицы `sales_sequence_profile`
--
...
--
-- Структура таблицы `sales_shipment`
--
...
--
-- Структура таблицы `sales_shipment_comment`
--
...
--
-- Структура таблицы `sales_shipment_grid`
--
...
--
-- Структура таблицы `sales_shipment_item`
--
...
--
-- Структура таблицы `sales_shipment_track`
--
...
--
-- Структура таблицы `sequence_creditmemo_0`
--
...
--
-- Структура таблицы `sequence_creditmemo_1`
--
...
--
-- Структура таблицы `sequence_invoice_0`
--
...
--
-- Структура таблицы `sequence_invoice_1`
--
...
--
-- Структура таблицы `sequence_order_0`
--
...
--
-- Структура таблицы `sequence_order_1`
--
...
--
-- Структура таблицы `sequence_shipment_0`
--
...
--
-- Структура таблицы `sequence_shipment_1`
--
...
--
-- Структура таблицы `setup_module`
--
...
--
-- Дамп данных таблицы `setup_module`
--
...
--
-- Дамп данных таблицы `store_group`
--
...
--
-- Структура таблицы `store_website`
--
...
--
-- Дамп данных таблицы `store_website`
--
...
(1, NULL, 'Magento/blank', 'Magento Blank', 'preview_image_56f1d6943e09a.jpeg', 0, 'frontend', 0, 'Magento/blank'),
(2, 1, 'Magento/luma', 'Magento Luma', 'preview_image_56f1d69471cf5.jpeg', 0, 'frontend', 0, 'Magento/luma'),
(3, NULL, 'Magento/backend', 'Magento 2 backend', NULL, 0, 'adminhtml', 0, 'Magento/backend');

-- --------------------------------------------------------

--
-- Структура таблицы `theme_file`
--
...
--
-- Дамп данных таблицы `url_rewrite`
--
...
--
-- Структура таблицы `variable_value`
--
...
--
-- Индексы таблицы `admin_passwords`
--
...
--
-- Индексы таблицы `admin_system_messages`
--
...
--
-- Индексы таблицы `authorization_rule`
--
...
--
-- Индексы таблицы `catalogsearch_fulltext_scope1`
--
ALTER TABLE `catalogsearch_fulltext_scope1`
  ADD PRIMARY KEY (`entity_id`,`attribute_id`),
  ADD FULLTEXT KEY `FTI_FULLTEXT_DATA_INDEX` (`data_index`);
...
--
-- Индексы таблицы `catalog_product_entity_media_gallery_value_to_entity`
--
...
--
-- Индексы таблицы `catalog_product_entity_media_gallery_value_video`
--
...
--
-- Индексы таблицы `catalog_url_rewrite_product_category`
--
...
--
-- Индексы таблицы `customer_grid_flat`
--
ALTER TABLE `customer_grid_flat`
  ...
  ADD FULLTEXT KEY `FTI_B691CA777399890C71AC8A4CDFB8EA99` (`name`,`email`,`created_in`,`taxvat`,`billing_full`,`billing_firstname`,`billing_lastname`,`billing_telephone`,`billing_postcode`,`billing_region`,`billing_city`,`billing_fax`,`billing_company`,`shipping_full`);
...
--
-- Индексы таблицы `customer_visitor`
--
...
--
-- Индексы таблицы `eav_attribute_option_swatch`
--
...
--
-- Индексы таблицы `googleoptimizer_code`
--
...
--
-- Индексы таблицы `import_history`
--
ALTER TABLE `import_history`
  ADD PRIMARY KEY (`history_id`);

--
-- Индексы таблицы `indexer_state`
--
...
--
-- Индексы таблицы `paypal_billing_agreement`
--
...
--
-- Индексы таблицы `paypal_billing_agreement_order`
--
...
--
-- Индексы таблицы `quote_address_item`
--
...
--
-- Индексы таблицы `quote_item_option`
--
...
--
-- Индексы таблицы `quote_shipping_rate`
--
...
--
-- Индексы таблицы `reporting_counts`
--
ALTER TABLE `reporting_counts`
  ADD PRIMARY KEY (`entity_id`);

--
-- Индексы таблицы `reporting_module_status`
--
ALTER TABLE `reporting_module_status`
  ADD PRIMARY KEY (`entity_id`);

--
-- Индексы таблицы `reporting_orders`
--
ALTER TABLE `reporting_orders`
  ADD PRIMARY KEY (`entity_id`);

--
-- Индексы таблицы `reporting_system_updates`
--
ALTER TABLE `reporting_system_updates`
  ADD PRIMARY KEY (`entity_id`);

--
-- Индексы таблицы `reporting_users`
--
...
--
-- Индексы таблицы `salesrule_coupon_aggregated`
--
...
--
-- Индексы таблицы `salesrule_coupon_aggregated_order`
--
...
--
-- Индексы таблицы `salesrule_coupon_aggregated_updated`
--
...
--
-- Индексы таблицы `sales_creditmemo`
--
...
--
-- Индексы таблицы `sales_creditmemo_comment`
--
...
--
-- Индексы таблицы `sales_creditmemo_grid`
--
ALTER TABLE `sales_creditmemo_grid`
  ...
  ADD FULLTEXT KEY `FTI_32B7BA885941A8254EE84AE650ABDC86` (`increment_id`,`order_increment_id`,`billing_name`,`billing_address`,`shipping_address`,`customer_name`,`customer_email`);

--
-- Индексы таблицы `sales_creditmemo_item`
--
...
--
-- Индексы таблицы `sales_invoice_comment`
--
...
--
-- Индексы таблицы `sales_invoice_grid`
--
ALTER TABLE `sales_invoice_grid`
  ...
  ADD FULLTEXT KEY `FTI_95D9C924DD6A8734EB8B5D01D60F90DE` (`increment_id`,`order_increment_id`,`billing_name`,`billing_address`,`shipping_address`,`customer_name`,`customer_email`);

--
-- Индексы таблицы `sales_invoice_item`
--
...
--
-- Индексы таблицы `sales_order_address`
--
...
--
-- Индексы таблицы `sales_order_grid`
--
ALTER TABLE `sales_order_grid`
  ...
  ADD FULLTEXT KEY `FTI_65B9E9925EC58F0C7C2E2F6379C233E7` (`increment_id`,`billing_name`,`shipping_name`,`shipping_address`,`billing_address`,`customer_name`,`customer_email`);

--
-- Индексы таблицы `sales_order_item`
--
...
--
-- Индексы таблицы `sales_order_payment`
--
...
--
-- Индексы таблицы `sales_order_status_history`
--
...
--
-- Индексы таблицы `sales_sequence_meta`
--
...
--
-- Индексы таблицы `sales_sequence_profile`
--
...
--
-- Индексы таблицы `sales_shipment`
--
...
--
-- Индексы таблицы `sales_shipment_comment`
--
...
--
-- Индексы таблицы `sales_shipment_grid`
--
ALTER TABLE `sales_shipment_grid`
  ...
  ADD FULLTEXT KEY `FTI_086B40C8955F167B8EA76653437879B4` (`increment_id`,`order_increment_id`,`shipping_name`,`customer_name`,`customer_email`,`billing_address`,`shipping_address`);

--
-- Индексы таблицы `sales_shipment_item`
--
...
--
-- Индексы таблицы `sales_shipment_track`
--
...
--
-- Индексы таблицы `sequence_creditmemo_0`
--
ALTER TABLE `sequence_creditmemo_0`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Индексы таблицы `sequence_creditmemo_1`
--
ALTER TABLE `sequence_creditmemo_1`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Индексы таблицы `sequence_invoice_0`
--
ALTER TABLE `sequence_invoice_0`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Индексы таблицы `sequence_invoice_1`
--
ALTER TABLE `sequence_invoice_1`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Индексы таблицы `sequence_order_0`
--
ALTER TABLE `sequence_order_0`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Индексы таблицы `sequence_order_1`
--
ALTER TABLE `sequence_order_1`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Индексы таблицы `sequence_shipment_0`
--
ALTER TABLE `sequence_shipment_0`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Индексы таблицы `sequence_shipment_1`
--
...
--
-- Индексы таблицы `variable_value`
--
...
--
-- AUTO_INCREMENT для таблицы `admin_passwords`
--
ALTER TABLE `admin_passwords`
...
--
-- AUTO_INCREMENT для таблицы `authorization_rule`
--
ALTER TABLE `authorization_rule`
...
ALTER TABLE `catalog_product_entity_media_gallery`
  MODIFY `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT для таблицы `catalog_product_entity_media_gallery_value`
--
ALTER TABLE `catalog_product_entity_media_gallery_value`
...
--
-- AUTO_INCREMENT для таблицы `customer_log`
--
ALTER TABLE `customer_log`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Log ID';
--
-- AUTO_INCREMENT для таблицы `customer_visitor`
--
ALTER TABLE `customer_visitor`
...
--
-- AUTO_INCREMENT для таблицы `eav_attribute_option_swatch`
--
ALTER TABLE `eav_attribute_option_swatch`
...
--
-- AUTO_INCREMENT для таблицы `flag`
--
ALTER TABLE `flag`
...
--
-- AUTO_INCREMENT для таблицы `googleoptimizer_code`
--
ALTER TABLE `googleoptimizer_code`
...
ALTER TABLE `oauth_token`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID';
--
-- AUTO_INCREMENT для таблицы `paypal_billing_agreement`
--
ALTER TABLE `paypal_billing_agreement`
  MODIFY `agreement_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Agreement Id';
--
...
ALTER TABLE `quote`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `quote_address`
--
ALTER TABLE `quote_address`
  MODIFY `address_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Address Id';
--
-- AUTO_INCREMENT для таблицы `quote_address_item`
--
ALTER TABLE `quote_address_item`
  MODIFY `address_item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Address Item Id';
--
-- AUTO_INCREMENT для таблицы `quote_id_mask`
--
ALTER TABLE `quote_id_mask`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `quote_item`
--
ALTER TABLE `quote_item`
  MODIFY `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Item Id';
--
-- AUTO_INCREMENT для таблицы `quote_item_option`
--
ALTER TABLE `quote_item_option`
  MODIFY `option_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Id';
--
-- AUTO_INCREMENT для таблицы `quote_payment`
--
ALTER TABLE `quote_payment`
  MODIFY `payment_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Payment Id';
--
-- AUTO_INCREMENT для таблицы `quote_shipping_rate`
--
ALTER TABLE `quote_shipping_rate`
...
--
-- AUTO_INCREMENT для таблицы `reporting_counts`
--
ALTER TABLE `reporting_counts`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `reporting_module_status`
--
ALTER TABLE `reporting_module_status`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Module Id';
--
-- AUTO_INCREMENT для таблицы `reporting_orders`
--
ALTER TABLE `reporting_orders`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `reporting_system_updates`
--
ALTER TABLE `reporting_system_updates`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `reporting_users`
--
ALTER TABLE `reporting_users`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
...
--
-- AUTO_INCREMENT для таблицы `salesrule_coupon_aggregated`
--
ALTER TABLE `salesrule_coupon_aggregated`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT для таблицы `salesrule_coupon_aggregated_order`
--
ALTER TABLE `salesrule_coupon_aggregated_order`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT для таблицы `salesrule_coupon_aggregated_updated`
--
ALTER TABLE `salesrule_coupon_aggregated_updated`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
...
ALTER TABLE `sales_bestsellers_aggregated_yearly`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT для таблицы `sales_creditmemo`
--
ALTER TABLE `sales_creditmemo`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `sales_creditmemo_comment`
--
ALTER TABLE `sales_creditmemo_comment`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `sales_creditmemo_item`
--
ALTER TABLE `sales_creditmemo_item`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
...
ALTER TABLE `sales_invoiced_aggregated_order`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT для таблицы `sales_invoice_comment`
--
ALTER TABLE `sales_invoice_comment`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `sales_invoice_item`
--
ALTER TABLE `sales_invoice_item`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
...
ALTER TABLE `sales_order`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `sales_order_address`
--
ALTER TABLE `sales_order_address`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
...
ALTER TABLE `sales_order_aggregated_updated`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT для таблицы `sales_order_item`
--
ALTER TABLE `sales_order_item`
  MODIFY `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Item Id';
--
-- AUTO_INCREMENT для таблицы `sales_order_payment`
--
ALTER TABLE `sales_order_payment`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `sales_order_status_history`
--
ALTER TABLE `sales_order_status_history`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
...
ALTER TABLE `sales_refunded_aggregated_order`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT для таблицы `sales_sequence_meta`
--
ALTER TABLE `sales_sequence_meta`
  MODIFY `meta_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT для таблицы `sales_sequence_profile`
--
ALTER TABLE `sales_sequence_profile`
  MODIFY `profile_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT для таблицы `sales_shipment`
--
ALTER TABLE `sales_shipment`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `sales_shipment_comment`
--
ALTER TABLE `sales_shipment_comment`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `sales_shipment_item`
--
ALTER TABLE `sales_shipment_item`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT для таблицы `sales_shipment_track`
--
ALTER TABLE `sales_shipment_track`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
...
ALTER TABLE `sales_shipping_aggregated_order`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT для таблицы `search_query`
--
ALTER TABLE `search_query`
...
--
-- AUTO_INCREMENT для таблицы `sequence_creditmemo_0`
--
ALTER TABLE `sequence_creditmemo_0`
  MODIFY `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `sequence_creditmemo_1`
--
ALTER TABLE `sequence_creditmemo_1`
  MODIFY `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `sequence_invoice_0`
--
ALTER TABLE `sequence_invoice_0`
  MODIFY `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `sequence_invoice_1`
--
ALTER TABLE `sequence_invoice_1`
  MODIFY `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `sequence_order_0`
--
ALTER TABLE `sequence_order_0`
  MODIFY `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `sequence_order_1`
--
ALTER TABLE `sequence_order_1`
  MODIFY `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `sequence_shipment_0`
--
ALTER TABLE `sequence_shipment_0`
  MODIFY `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `sequence_shipment_1`
--
ALTER TABLE `sequence_shipment_1`
  MODIFY `sequence_value` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT для таблицы `theme_file`
--
ALTER TABLE `theme_file`
...
--
-- Ограничения внешнего ключа таблицы `admin_passwords`
--
ALTER TABLE `admin_passwords`
...
--
-- Ограничения внешнего ключа таблицы `authorization_rule`
--
ALTER TABLE `authorization_rule`
...
--
-- Ограничения внешнего ключа таблицы `catalog_product_entity_media_gallery_value_to_entity`
--
ALTER TABLE `catalog_product_entity_media_gallery_value_to_entity`
...
--
-- Ограничения внешнего ключа таблицы `catalog_product_entity_media_gallery_value_video`
--
ALTER TABLE `catalog_product_entity_media_gallery_value_video`
...
--
-- Ограничения внешнего ключа таблицы `catalog_url_rewrite_product_category`
--
ALTER TABLE `catalog_url_rewrite_product_category`
...
--
-- Ограничения внешнего ключа таблицы `eav_attribute_option_swatch`
--
ALTER TABLE `eav_attribute_option_swatch`
...
--
-- Ограничения внешнего ключа таблицы `googleoptimizer_code`
--
ALTER TABLE `googleoptimizer_code`
...
--
-- Ограничения внешнего ключа таблицы `integration`
--
ALTER TABLE `integration`
...
--
-- Ограничения внешнего ключа таблицы `layout_link`
--
ALTER TABLE `layout_link`
...
--
-- Ограничения внешнего ключа таблицы `oauth_nonce`
--
ALTER TABLE `oauth_nonce`
...
--
-- Ограничения внешнего ключа таблицы `paypal_billing_agreement`
--
ALTER TABLE `paypal_billing_agreement`
...
--
-- Ограничения внешнего ключа таблицы `paypal_billing_agreement_order`
--
ALTER TABLE `paypal_billing_agreement_order`
...
--
-- Ограничения внешнего ключа таблицы `quote_item_option`
--
ALTER TABLE `quote_item_option`
...
--
-- Ограничения внешнего ключа таблицы `salesrule_coupon_aggregated`
--
ALTER TABLE `salesrule_coupon_aggregated`
...
--
-- Ограничения внешнего ключа таблицы `salesrule_coupon_aggregated_order`
--
ALTER TABLE `salesrule_coupon_aggregated_order`
...
--
-- Ограничения внешнего ключа таблицы `salesrule_coupon_aggregated_updated`
--
ALTER TABLE `salesrule_coupon_aggregated_updated`
...
--
-- Ограничения внешнего ключа таблицы `sales_creditmemo`
--
ALTER TABLE `sales_creditmemo`
...
--
-- Ограничения внешнего ключа таблицы `sales_creditmemo_comment`
--
ALTER TABLE `sales_creditmemo_comment`
...
--
-- Ограничения внешнего ключа таблицы `sales_creditmemo_item`
--
ALTER TABLE `sales_creditmemo_item`
...
--
-- Ограничения внешнего ключа таблицы `sales_invoice`
--
ALTER TABLE `sales_invoice`
...
--
-- Ограничения внешнего ключа таблицы `sales_invoice_comment`
--
ALTER TABLE `sales_invoice_comment`
...
--
-- Ограничения внешнего ключа таблицы `sales_invoice_item`
--
ALTER TABLE `sales_invoice_item`
...
--
-- Ограничения внешнего ключа таблицы `sales_order_address`
--
ALTER TABLE `sales_order_address`
...
--
-- Ограничения внешнего ключа таблицы `sales_order_item`
--
ALTER TABLE `sales_order_item`
...
--
-- Ограничения внешнего ключа таблицы `sales_order_payment`
--
ALTER TABLE `sales_order_payment`
...
--
-- Ограничения внешнего ключа таблицы `sales_order_status_history`
--
ALTER TABLE `sales_order_status_history`
...
--
-- Ограничения внешнего ключа таблицы `sales_sequence_profile`
--
ALTER TABLE `sales_sequence_profile`
...
--
-- Ограничения внешнего ключа таблицы `sales_shipment`
--
ALTER TABLE `sales_shipment`
...
--
-- Ограничения внешнего ключа таблицы `sales_shipment_comment`
--
ALTER TABLE `sales_shipment_comment`
...
--
-- Ограничения внешнего ключа таблицы `sales_shipment_item`
--
ALTER TABLE `sales_shipment_item`
...
--
-- Ограничения внешнего ключа таблицы `sales_shipment_track`
--
ALTER TABLE `sales_shipment_track`
...
--
-- Ограничения внешнего ключа таблицы `search_query`
--
ALTER TABLE `search_query`
...
--
-- Ограничения внешнего ключа таблицы `store_group`
--
ALTER TABLE `store_group`
...
--
-- Ограничения внешнего ключа таблицы `theme_file`
--
ALTER TABLE `theme_file`
...
--
-- Ограничения внешнего ключа таблицы `ui_bookmark`
--
ALTER TABLE `ui_bookmark`
...
--
-- Ограничения внешнего ключа таблицы `variable_value`
--
ALTER TABLE `variable_value`
...
--
-- Ограничения внешнего ключа таблицы `widget_instance`
--
ALTER TABLE `widget_instance`
